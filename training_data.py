...
category_metadata = {
    "Workplace Harassment": {
        "department": "Internal Complaints Committee",
    },
    "Gender Violence": {
    ...
    "Gender Discrimination":{
        "department":'State Women Commission'
    },
    'Sexual Harassment':{
        "department":'Special Women\'s Police Unit'
    },
...
def get_training_data():
   ...
   # Ensure we have matching number of samples and categories
    assert len(training_samples['text']) == len(training_samples['category']), \
        "Text and category lists must be of equal length"
...
def get_department_info(category):
    """Map complaint categories to departments with contact info"""
    department_map = {
        'Workplace Harassment': {
            'department': 'Internal Complaints Committee',
            'email': 'icc@organization.org',
            'phone': '+911234567890'
        },
        'Gender Violence': {
            'department': 'Women Protection Cell',
            'email': 'wpc@organization.org',
            'phone': '+911234567891'
        },
        'Child Marriage': {
            'department': 'Child Welfare Committee',
            'email': 'cwc@organization.org',
            'phone': '+911234567892'
        },
        'Domestic Abuse': {
            'department': 'Domestic Violence Helpline',
            'email': 'dvh@organization.org',
            'phone': '+911234567893'
        },
        'Education Rights Violation': {
            'department': 'Education Board Grievance Cell',
            'email': 'ebgc@organization.org',
            'phone': '+911234567894'
        },
        'Discrimination': {
            'department': 'Equal Opportunity Commission',
            'email': 'eoc@organization.org',
            'phone': '+911234567895'
        },
        'Sexual Harassment': {
            'department': 'Special Women\'s Police Unit',
            'email': 'swpu@organization.org',
            'phone': '+911234567896'
        },
        'Legal Issues': {
            'department': 'Legal Aid Services',
            'email': 'legal@organization.org',
            'phone': '+911234567897'
        },
        'Cyberbullying': {
            'department': 'Cyber Crime Cell',
            'email': 'cyber@organization.org',
            'phone': '+911234567898'
        },
        'Healthcare Access Denial': {
            'department': 'Health Department Grievance Cell',
            'email': 'health@organization.org',
            'phone': '+911234567899'
        }
    }
    return department_map.get(category, {
        'department': 'General Grievance Desk',
        'email': 'help@organization.org',
        'phone': '+911234567000'
    })

def get_categories():
    """Returns list of unique categories"""
    return list(set(training_samples['category']))
...
print(get_department_info("Workplace Harassment"))
print(get_department_info("Unknown Category"))